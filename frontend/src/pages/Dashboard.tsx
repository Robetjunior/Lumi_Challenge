  ...
  return (
    <div className="dashboard-container fade-in">
      ...
      <div className="cards-grid">
        <DashboardCard 
          icon={<FaBolt /> as unknown as JSX.Element} 
        ...
        />
        <DashboardCard 
          icon={<FaBurn /> as unknown as JSX.Element} 
        ...
        />
        <DashboardCard 
          icon={<FaLeaf /> as unknown as JSX.Element} 
        ...
        />
        <DashboardCard 
          icon={<FaWallet /> as unknown as JSX.Element} 
